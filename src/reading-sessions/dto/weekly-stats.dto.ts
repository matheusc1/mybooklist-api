...
export class PagesByDayDto {
  @ApiProperty({
    description: 'Day label in the current week.',
    example: 'Mon',
  })
  day: string
...
export class WeeklyStatsDto {
  ...
  @ApiProperty({
    description: 'Total reading time in minutes for the current week.',
    example: 180,
  })
  ...
  @ApiProperty({
    description:
      'Most active day by page count. Null when no pages were read this week.',
    type: String,
    nullable: true,
    example: 'Wed',
  })
  ...
  @ApiProperty({
    description: 'Current consecutive streak of read days.',
    example: 3,
  })
  daysStreak: number
}
